...
##load data
wtreat = read.csv('houses.data/white.treat.effect.mean.boot.csv') 
wtreat.lower = read.csv('houses.data/white.treat.effect.conf.boot.lower.csv') 
wtreat.upper = read.csv('houses.data/white.treat.effect.conf.boot.upper.csv') 
Nwtreat = read.csv('houses.data/white.treat.N.csv')
btreat = read.csv('houses.data/black.treat.effect.mean.boot.csv') 
btreat.lower = read.csv('houses.data/black.treat.effect.conf.boot.lower.csv') 
btreat.upper = read.csv('houses.data/black.treat.effect.conf.boot.upper.csv') 
Nbtreat = read.csv('houses.data/black.treat.N.csv')
...
for(figure in c('white.basic.main','white.demo.main','white.demo.property','white.demo.localrace','blackmain','blackcensus')){
	if(figure == 'white.basic.main'){
		...
		treat = read.csv('houses.data/white.match.basic.csv')
		treat.2 = read.csv('houses.data/white.match.basic.property.csv')
		fig.nums = c('A3','A4') ##figure names
		pchs = c(17,17) ##point types
		}
	if(figure == 'white.demo.main'){
		treat = read.csv('houses.data/white.match.nondemolished.csv')
		diffs = read.csv('houses.data/white.match.nondemolished.diffs.csv')
		fig.nums = c('2','A5')
		pchs = c(17,22)
		}
	if(figure == 'white.demo.property'){
		treat = read.csv('houses.data/white.match.nondemolished.property.csv')
		diffs = read.csv('houses.data/white.match.nondemolished.diffs.property.csv')
		fig.nums = c('A6','A7')	
		pchs = c(17,22)
		}	
	if(figure == 'white.demo.localrace'){
		treat = read.csv('houses.data/white.match.nondemolished.localrace.csv')
		diffs = read.csv('houses.data/white.match.nondemolished.diffs.localrace.csv')
		fig.nums = c('A8','A9')			
		pchs = c(17,22)
		}
	if(figure == 'blackmain'){
		treat = read.csv('houses.data/white.match.black.property.csv')
		diffs = read.csv('houses.data/white.match.black.diffs.property.csv')
		fig.nums = c('3','A12')
		pchs = c(17,21)			
		}
	if(figure == 'blackcensus'){
		treat = read.csv('houses.data/white.match.black.csv')
		diffs = read.csv('houses.data/white.match.black.diffs.csv')
		fig.nums = c('A10','A11')
		pchs = c(17,21)	
		}
...
# load('houses.data/out.reg.predictions.rda') ##load saved model
...
distdat =  read.csv('houses.data/predicted.results.distance.vary.context.csv')
areadat = read.csv('houses.data/predicted.results.area.vary.context.csv')
...
dists = read.csv('houses.data/distance.vote.differences.csv')
demos = read.csv('houses.data/demolished.vote.differences.csv')
...
groups = read.csv('houses.data/par.trends.csv')
