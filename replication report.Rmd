...
```{r }
#Figures 2: Treatment Effects Using Matched White Voters Near Nondemolished Projects for Control Group,
# and Figure 3: Treatment Effects Using Matched Black Control Group and Controlling for Homeownership

##this cycles thorugh a bunch of dataframes, each of which is needed for a
...
treat.white.match <- read_csv('houses.data/white.match.nondemolished.csv')
diffs.white.match <- read_csv('houses.data/white.match.nondemolished.diffs.csv')

# and for figure 3

treat.black.match <- read_csv('houses.data/white.match.black.property.csv')
diffs.black.match <- read_csv('houses.data/white.match.black.diffs.property.csv')
